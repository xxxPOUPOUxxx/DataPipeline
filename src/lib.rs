...
#[derive(Debug)]
pub struct DataPipelineProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DataPipelineProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DataPipeline processing");
    
    let mut processor = DataPipelineProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DataPipelineProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DataPipelineProcessor::new(false);
